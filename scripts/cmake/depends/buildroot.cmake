...
download_dependency(buildroot URL ${BR_URL} URL_MD5 ${BR_URL_MD5})
...
set(LINUX_BIN_DIR ${BR_BIN_DIR}/build/linux-hk CACHE INTERNAL "")
set(LINUX_SRC_DIR ${LINUX_BIN_DIR} CACHE INTERNAL "")
execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${LINUX_BIN_DIR})
...
if(ERB_LINUX_OVERRIDE)
    set(LINUX_SRC_DIR ${ERB_LINUX_OVERRIDE} CACHE INTERNAL "")
