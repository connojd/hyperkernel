...
#ifndef VMCALL_EVENT_INTEL_X64_HYPERKERNEL_H
#define VMCALL_EVENT_INTEL_X64_HYPERKERNEL_H
...
class EXPORT_HYPERKERNEL_HVE vmcall_event_op_handler
{
public:
...
private:
    ...
    uint64_t event_op__send(gsl::not_null<vcpu_t *> vcpu);
